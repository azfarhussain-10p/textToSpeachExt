 ...
 */
function createOptionElement(text, value, selected = false) {
 ...
 */
function createButtonElement(text, className, clickHandler = null) {
 ...
 */
function createElementStructure(structure) {
 ...
 */
function setSafeContent(element, contentStructure) {
